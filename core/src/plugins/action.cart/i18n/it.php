...
$mess = array(
    ...
    "1" => "Alla selezione del carrello",
    "2" => "Aggiungi gli elementi selezionati al carrello attuale",
    "3" => "Svuota",
    "4" => "Svuota il carrello attuale",
    "5" => "Nuovo",
    "6" => "Nuova selezione del carrello",
    "7" => "Download",
    "8" => "Download l'intero carrello",
    "9" => "Carrello di default",
    "10"=> "Carrelli",
