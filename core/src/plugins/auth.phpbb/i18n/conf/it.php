...
"Authentication is done remotely (useful in CMS system)." => "L'autenticazione è eseguita in remoto (utilizzando il sistema integrato nel CMS).",
...
"PHPbb" => "PHPbb",
"The phpbb path" => "Il percorso di PHPbb",
"Users" => "Utenti",
"The users list" => "Lista utenti",
"PHPBB authentication" => "Autenticazione PHPBB",
