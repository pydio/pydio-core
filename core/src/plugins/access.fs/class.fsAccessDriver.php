...
class fsAccessDriver extends AbstractAccessDriver implements AjxpWrapperProvider
{
    ...
    */
    ...
    public function initRepository()
    {
        ...
        $path = SystemTextEncoding::fromUTF8($this->repository->getOption("PATH"));
    ...
    {
        $newOptions = array(
            "PATH" => SystemTextEncoding::fromUTF8($repository->getOption("PATH")).AJXP_Utils::decodeSecureMagic($httpVars["file"]),
