...
"Host" => "URL",
"Host of the WebDAV server, with http/https and without trailing slash. Can contain user:password too." => "URL des WebDAV Servers, mit http/https und ohne abschliessendem Schrägstrich. Kann auch user:password enthalten.",
"Uri" => "Uri",
