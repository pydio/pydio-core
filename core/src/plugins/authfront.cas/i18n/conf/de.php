...
$mess = array(
    "Order" => "Reihenfolge.",
    "Order this plugin with other auth frontends" => "Dieses Plugin unter den anderen Authentifikations-Frontends einordnen",
    "Create User" => "Benutzer erstellen",
    "Automatically create user if it does not already exists" => "Automatisch einen Benutzer anlegen, wenn dieser noch nicht existiert",
    "General" =>"Allgemein" ,
    "Protocol Type" =>"Protokoll Typ",
    "Enable/disable automatically based on the protocol used" => "Aktiviere/Deaktiviere automatisch abhängig vom benutzten Protokoll",
    "CAS server address" => "Adresse des CAS server",
    ...
    "Config for Proxy Granting Ticket Storage. If is file option, location for storate is session_save_path()" => "Proxy stellt einen Ticketspeicher bereit. Bei einer Datei ist der Speicherort session_save_path().",
    "Install SQL Table (support only mysql)" => "SQL Tabelle installieren (nur MySQL)"
);
