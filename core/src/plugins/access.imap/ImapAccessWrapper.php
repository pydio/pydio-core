...
class ImapAccessWrapper implements IAjxpWrapper
{
    ...
    public static function closeStreamFunc()
    {
        if (self::$currentStream) {
            Logger::debug("Closing stream now!");
    ...
    public function stream_open($path, $mode, $options, &$opened_path)
    {
        ...
        if (self::$currentStream != null) {
            Logger::debug(__CLASS__,__FUNCTION__,"Using currently opened stream! ".print_r(self::$currentStream, true));
            ...
            Logger::debug(__CLASS__,__FUNCTION__,"Opening a new stream ".$server." with mailbox '".$this->mailbox."'");
            try {
