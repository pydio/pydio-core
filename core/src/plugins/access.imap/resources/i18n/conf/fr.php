...
"When a folder will contain more items than this number, display will switch to pagination mode, for better performances." => "Nombre d'items pour lesquels la liste est paginée.",
