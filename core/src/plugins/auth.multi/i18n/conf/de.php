...
$mess=array(
"Multiple" => "Mehrere",
"Encapsulate the use of other drivers" => "Fasst mehrere andere Treiber zusammen",
"Master" => "Master",
"The name of the master driver to use, generally serial." => "Name des verwendeten Treibers für die Master-Instanz.",
"Drivers" => "Treiber",
"The auth drivers definition, see detailed documenation for more info." => "Definition des Authentifizierungs-Treibers (siehe Doku)",
...
"Mode" => "Modus",
"Master/slave will assume that the master is read-only, and the slave is a local alternative to allow sharing features." => "Bei Master/slave wird auf den Master nur lesend zugegriffen, während der Slave alternativ für Freigaben verwendet wird.",
"Listing" => "Angezeigte Benutzer",
