...
"Where to update" => "Sitio de actualización. /pub/ es el servidor público para la edición de la comunidadm /auth es el servidor para la edición empresarial. Asegurate de rellenar la Autenticación del Sitio de Actualización con el API key/Secret disponible en tu cuenta en Pydio.com.",
...
"Enable the migration action, available in the Settings repository" => "Activar la función de migración, disponible en el workspace Configuraciones",
