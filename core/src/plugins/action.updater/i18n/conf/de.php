...
"Where to update" => "Über diese URL wird geprüft, ob eine Versionsaktualisierung vorliegt.",
...
"Check stable or dev channel" => "Legt fest, in welchem Kanal nach Aktualisierungen gesucht wird.",
