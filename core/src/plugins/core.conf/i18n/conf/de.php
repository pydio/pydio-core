...
"Simple SQL Connexion definition that can be used by other sql-based plugins" => "Definition der SQL-Verbindung, auf die andere SQL-Basierte Erweiterungen zugreifen können",
...
"Allow the users to pick an existing user when sharing a folder" => "Benutzer dürfen beim Freigeben von Elementen andere Benutzer auswählen.",
"Create external users" => "Benutzer für Freigaben erstellen",
"Allow the users to create a new user when sharing a folder" => "Benutzer dürfen beim Freigeben von Elementen weitere Benutzer erstellen.",
"External users parameters" => "Parameter bei der Analge von Freigabebenutzern",
"List of parameters to be edited when creating a new shared user." => "Liste mit Parametern, die beim Erstellen eines neuen Benutzers, während der Freigabe von Elementen, festgelegt werden müssen.",
...
"Share with existing users from all groups" => "Für Benutzer aller Gruppen freigeben",
