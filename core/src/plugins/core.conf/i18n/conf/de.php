...
"Core SQL Connexion" => "Core SQL Verbindung",
...
"Preferences Saving" => "Voreinstellungen Speichern",
"Skip user history" => "Oberflächeneinstellungen überspringen",
...
"Users completer limit" => "Benutzer in AutoComplete",
"Minimum number of characters to trigger the auto completion feature" => "Minimale Anzahl an Zeichen, bevor die AutoComplete-Auswahl angezeigt wird",
"Users completer min chars" => "AutoComplete ab",
"Do not display real login in parenthesis" => "Login-Namen nicht in Klammern anzeigen",
"Hide real login" => "Login verstecken",
...
"Create external users" => "Externe Benutzer erstellen",
"Allow the users to create a new user when sharing a folder" => "Erlaubt den Benutzer das erstellen von anderen Benutzern für das Teilen von Ordnern.",
"External users parameters" => "Parameter für externe Benutzer",
"List of parameters to be edited when creating a new shared user." => "Liste mit Parametern, die beim Anlegen eines neuen Benutzers festgelegt werden müssen.",
"Configuration Store Instance" => "Instanz für den Konfigurationsspeicher",
"Instance" => "Instanz",
"Choose the configuration plugin" => "Konfigurations-Plugin auswählen",
"Name" => "Name",
