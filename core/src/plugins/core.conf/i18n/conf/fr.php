...
"Skip user history" => "Ne pas garder les préférences",
"Use this option to avoid automatic reloading of the interface state (last folder, opened tabs, etc)" => "Utiliser cette option pour éviter le rechargement du dernier état d'un workspace (dernier répertoire ouvert, onglets ouverts, etc)",
