...
$mess = [
    ...
    "tour.welcomemodal.title" => "Bienvenido a APPLICATION_TITLE",
    "tour.welcomemodal.subtitle" => "¡Arrastre y suelte su mejor foto para su perfil! Le haremos una visita rápida para guiarle por la interfaz web.",
    "tour.welcomemodal.skip" => "Salta",
    "tour.welcomemodal.start" => "Empezar la visita",

    "tour.create-menu.title" => "Añadir archivos",
    ...
    "tour.create-menu"=>"Empiece a añadir nuevos archivos o carpetas al workpsace actual.",
    "tour.infopanel.1"=> "Aquí encontrará información sobre la selección actual: información de archivo, estado del intercambio, metadatos definidos por el usuario, etc.",
    "tour.infopanel.2"=> "Puede cerrar este panel usando el botón de información en la barra de visualización",
    "tour.infopanel.search"=> "Buscar",
    "tour.infopanel.folder"=> "Carpeta",
    "tour.infopanel.file"=> "Archivo",
    "tour.uwidget.addressbook" => "Directorio de todos los usuarios con acceso a la plataforma. Cree sus propios usuarios y equipos que para compartir recursos",
    "tour.uwidget.alerts" => "El panel de alertas le informará cuando un usuario con quien ha compartido algún recurso acceda al mismo. Puede enviarle directamente un correo.",
    "tour.uwidget.menu" => "Acceder a otras opciones: gestionar su perfil y opciones de seguridad, explorar recursos compartidos, salir de la plataforma.",
    "tour.uwidget.home" => "Vuelva al panel de bienvenida con este botón",
    ...
    "tour.locale.last" => "Finalizar",
    "tour.locale.next" => "Siguiente",
    "tour.locale.skip" => "Saltar",
];
