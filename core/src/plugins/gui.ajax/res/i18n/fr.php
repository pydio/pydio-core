...
$mess = [
    ...
    "tour.welcomemodal.title" => "Bienvenue sur APPLICATION_TITLE",
    "tour.welcomemodal.subtitle" => "Glissez ici votre meilleur photo pour votre profil! Cette petite visite va vous introduire brièvement l'interface web.",
    "tour.welcomemodal.skip" => "Ignorer",
    "tour.welcomemodal.start" => "Démarrer le tour",

    "tour.create-menu.title" => "Ajouter des fichiers",
    ...
    "tour.create-menu"=>"Ajoutez des fichiers ou des répertoires au workspace courant",
    "tour.infopanel.1"=> "Vous trouverez ici différentes informations concernant la sélection courante: infos sur le fichier, statut de partage, méta-données, etc.",
    "tour.infopanel.2"=> "Vous pouvez fermer le panneau en appuyant sur le bouton Info dans la barre d'outil",
    "tour.infopanel.search"=> "Recherche",
    "tour.infopanel.folder"=> "Dossier",
    "tour.infopanel.file"=> "Fichier",
    "tour.uwidget.addressbook" => "Annuaire de tous les utilisateurs accédant à la plateforme. Créez vos propres utilisateurs et constituez des équipes pour partager facilement des fichiers avec plusieurs personnes.",
    "tour.uwidget.alerts" => "Les alertes vous informent lorsqu'un utilisateur accède à une ressource partagée. Vous pouvez les recevoir directement par email.",
    "tour.uwidget.menu" => "Accéder à d'autres options : gestion de votre profil et options de sécurité, accès à tous vos partages, déconnexion.",
    "tour.uwidget.home" => "Retour à la page d'accueil",
    ...
    "tour.locale.last" => "Terminer",
    "tour.locale.next" => "Suivant",
    "tour.locale.skip" => "Ignorer",
];