...
var Action = (function (_Observable) {
  ...
  */
	...
	_createClass(Action, [{
		key: '_evalScripts',
		value: function _evalScripts(data, localScopeMetadata) {
   ...
   */
		...
		key: 'createFromXML',
		value: function createFromXML(xmlNode) {
   ...
   */
		...
		key: 'buildSubmenuStaticItems',
		value: function buildSubmenuStaticItems() {
			var menuItems = [];
			if (this.subMenuItems.staticItems) {
   ...
   */
		...
		key: 'prepareSubmenuDynamicBuilder',
		value: function prepareSubmenuDynamicBuilder() {
   ...
   */
		...
		key: 'setIconSrc',
		value: function setIconSrc(newSrc, iconClass) {
   ...
   */
		...
		key: 'setLabel',
		value: function setLabel(newLabel, newTitle) {
  ...
  */
   ...
   */
		...
		key: 'refreshFromI18NHash',
		value: function refreshFromI18NHash() {
   ...
   */
		...
		key: 'getKeyedText',
		value: function getKeyedText(displayString, hasAccessKey, accessKey) {
			if (!displayString) {
   ...
   */
		...
		key: 'attributesToObject',
		value: function attributesToObject(object, node) {
