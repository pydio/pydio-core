...
var Controller = (function (_Observable) {
    ...
    function Controller(pydioObject) {
        var dataModelElementId = arguments[1] === undefined ? null : arguments[1];
    ...
    _createClass(Controller, [{
        ...
        value: function parseXmlMessage(xmlDoc) {
            if (console) console.warn("Controller.parseXmlMessage() is deprecated, use PydioApi instead", new Error());
        ...
        value: function submitForm(formName, post, completeCallback) {
            if (console) console.warn("Controller.submitForm() is deprecated, use PydioApi instead", new Error());
        ...
        value: function loadActionsFromRegistry() {
            var registry = arguments[0] === undefined ? null : arguments[0];
