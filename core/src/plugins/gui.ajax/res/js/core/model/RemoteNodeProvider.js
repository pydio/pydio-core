...
var RemoteNodeProvider = (function () {
    ...
    _createClass(RemoteNodeProvider, [{
        key: 'initProvider',
         ...
         * @param aSync bool
         */
        value: function loadLeafNodeSync(node, nodeCallback) {
        ...
        key: 'refreshNodeAndReplace',
        value: function refreshNodeAndReplace(node, onComplete) {
         ...
         * @param childrenOnly
         */
        value: function parseNodes(origNode, transport, nodeCallback, childCallback, childrenOnly) {
        ...
        key: 'parseAjxpNodesDiffs',
        value: function parseAjxpNodesDiffs(xmlElement, targetDataModel) {
         ...
         * @returns AjxpNode
         */
        value: function parseAjxpNode(xmlNode) {
