...
var PydioApi = (function () {
    ...
    PydioApi.prototype.applyCheckHook = function applyCheckHook(node, hookName, hookArg, completeCallback) {
        var params = {
    ...
    PydioApi.prototype.submitForm = function submitForm(formName, post, completeCallback) {
        var params = {};
    ...
    PydioApi.prototype.triggerDownload = function triggerDownload(url) {
