...
var PathUtils = (function () {
    ...
    _createClass(PathUtils, null, [{
        key: "getBasename",
        value: function getBasename(fileName) {
        ...
        key: "getDirname",
        value: function getDirname(fileName) {
            return fileName.substr(0, fileName.lastIndexOf("/"));
        }
    }, {
        key: "getAjxpMimeType",
        value: function getAjxpMimeType(item) {
            if (!item) return "";
        ...
        key: "roundFileSize",
        value: function roundFileSize(filesize) {
            var size_unit = arguments.length <= 1 || arguments[1] === undefined ? "o" : arguments[1];
        ...
        key: "formatModifDate",
        value: function formatModifDate(dateObject, format) {
