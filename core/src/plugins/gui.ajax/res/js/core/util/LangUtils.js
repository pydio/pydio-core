...
var LangUtils = (function () {
    ...
    _createClass(LangUtils, null, [{
        key: 'arrayWithout',
        value: function arrayWithout(array, key) {
        ...
        key: 'forceJSONArrayToObject',
        value: function forceJSONArrayToObject(container, value) {
        ...
        key: 'simpleCopy',
        value: function simpleCopy(source) {
            var copy = {};
        ...
        value: function mergeObjectsRecursive(source, destination) {
            var newObject = {},
                property;
