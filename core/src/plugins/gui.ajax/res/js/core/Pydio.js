...
var Pydio = (function (_Observable) {
    ...
    function Pydio(parameters) {
        ...
        _get(Object.getPrototypeOf(Pydio.prototype), 'constructor', this).call(this);
    ...
    _createClass(Pydio, [{
        ...
        key: 'loadXmlRegistry',
        value: function loadXmlRegistry(sync) {
            var xPath = arguments.length <= 1 || arguments[1] === undefined ? null : arguments[1];
            var completeFunc = arguments.length <= 2 || arguments[2] === undefined ? null : arguments[2];
        ...
        key: 'tryLogUserFromCookie',
        value: function tryLogUserFromCookie() {}
        ...
        */
        ...
        key: 'loadActiveRepository',
        value: function loadActiveRepository() {
        ...
        key: 'reloadRepositoriesList',
        value: function reloadRepositoriesList() {
            if (!this.user) return;
        ...
        key: 'loadRepository',
        value: function loadRepository(repository) {
        ...
        key: 'goTo',
        value: function goTo(nodeOrPath) {
            var path;
        ...
        key: 'triggerRepositoryChange',
        value: function triggerRepositoryChange(repositoryId) {
        ...
        key: 'loadI18NMessages',
        value: function loadI18NMessages(newLanguage) {
            var onComplete = (function (transport) {
        ...
        key: 'displayMessage',
        value: function displayMessage(messageType, message) {
        ...
        value: function updateContextData(ajxpContextNode, ajxpSelectedNodes, selectionSource) {
            if (ajxpContextNode) {
        ...
        key: 'getContextHolder',
        value: function getContextHolder() {
        ...
        value: function getUserSelection() {
            return this._contextHolder;
        }
        ...
        key: 'fireContextRefresh',
        value: function fireContextRefresh() {
        ...
        key: 'fireNodeRefresh',
        value: function fireNodeRefresh(nodePathOrNode, completeCallback) {
