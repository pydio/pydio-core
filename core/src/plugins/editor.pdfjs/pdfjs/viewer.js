...
//'use strict'; // Won't load with this in Pydio.
...
/* Adjust paths for Pydio. */
PDFJS.imageResourcesPath = 'plugins/editor.pdfjs/pdfjs/images/';
  PDFJS.workerSrc = 'plugins/editor.pdfjs/pdfjs/pdf.worker.js';
  PDFJS.cMapUrl = 'plugins/editor.pdfjs/pdfjs/cmaps/';
...
function webViewerInitialized() {
  ...
  var file = DEFAULT_URL; // File path is provided by Pydio.
...
// Will be triggered by Pydio tab instead.
