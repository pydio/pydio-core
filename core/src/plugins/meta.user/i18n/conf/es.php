...
"Hidden file used inside folders to save meta data" => "Archivo oculto usado en el directorio para guardas los metadatos", // This is not used (code is commented out in manifest.xml)
