...
*/
$mess=array(
"Standard login screen" => "Standard Anmelde-Bildschirm",
"Display a standard user/password login screen" => "Den Standard-Bildschirm zum Anmelden mit Benutzername und Passwort anzeigen",
