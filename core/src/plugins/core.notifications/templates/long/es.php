...
$mess=array(
"file.add" => "El fichero AJXP_NODE_LABEL fue creado en AJXP_PARENT_PATH el AJXP_DATE por AJXP_USER.",
"file.delete" => "El fichero AJXP_NODE_LABEL fue eliminado de AJXP_PARENT_PATH el AJXP_DATE, por AJXP_USER.",
"file.change" => "El fichero AJXP_NODE_LABEL fue modificado el AJXP_DATE, por AJXP_USER.",
"file.rename" => "El fichero AJXP_SOURCE_LABEL fue renombrado a AJXP_NODE_LABEL el AJXP_DATE, por AJXP_USER.",
"file.view" => "El fichero AJXP_NODE_LABEL fue consultado por AJXP_USER el AJXP_DATE.",
"file.copy" => "El fichero AJXP_NODE_LABEL fue copiado desde AJXP_SOURCE_FOLDER a AJXP_PARENT_PATH el AJXP_DATE, por AJXP_USER.",
"file.copy_to" => "El fichero AJXP_NODE_LABEL fue copiado a AJXP_TARGET_FOLDER el AJXP_DATE, por AJXP_USER.",
"file.copy_from" => "El fichero AJXP_NODE_LABEL fue copiado desde AJXP_SOURCE_FOLDER el AJXP_DATE, por AJXP_USER.",
"file.move" => "El fichero AJXP_NODE_LABEL fue movido desde AJXP_SOURCE_FOLDER a AJXP_PARENT_PATH el AJXP_DATE, por AJXP_USER.",
"file.move_to" => "El fichero AJXP_NODE_LABEL fue movido a AJXP_TARGET_FOLDER el AJXP_DATE, por AJXP_USER.",
"file.move_from" => "El fichero AJXP_NODE_LABEL fue movido desde AJXP_SOURCE_FOLDER el AJXP_DATE, por AJXP_USER.",
...
"ajxp_link" => "Hacer click aquí para ir directamente a <a href='AJXP_LINK'>AJXP_NODE_LABEL</a>",
