...
$mess=array(
    "user_link"  => "von",
    "file.add" => "In den Repositorie AJXP_REPOSITORY_LABEL wurde, innerhalb des Ordners AJXP_PARENT_PATH, die Datei AJXP_NODE_LABEL erstellt. AJXP_DATE, von AJXP_USER",
"file.delete" => "Die Datei AJXP_NODE_LABEL wurde aus AJXP_PARENT_PATH gelöscht. AJXP_DATE, von AJXP_USER",
"file.change" => "Die Datei AJXP_NODE_LABEL wurde geändert. AJXP_DATE, von AJXP_USER",
"file.view" => "Die Datei AJXP_NODE_LABEL wurde von AJXP_USER betrachtet. AJXP_DATE",
"file.copy_to" => "Die Datei AJXP_NODE_LABEL wurde nach AJXP_TARGET_FOLDER kopiert. AJXP_DATE, von AJXP_USER",
"file.copy_from" => "Die Datei AJXP_NODE_LABEL wurde von AJXP_SOURCE_FOLDER kopiert. AJXP_DATE, von AJXP_USER",
...
"folder.change" => "In den Repositorie AJXP_REPOSITORY_LABEL wurde der Inhalt des Verzeichnisses AJXP_NODE_LABEL bearbeitet. AJXP_DATE, von AJXP_USER",
"folder.view" => "Das Verzeichnis AJXP_NODE_LABEL wurde von AJXP_USER geöffnet. AJXP_DATE, von AJXP_USER",
...
"file.rename" => "Die Datei AJXP_SOURCE_LABEL wurde zu AJXP_NODE_LABEL umbenannt. AJXP_DATE, von AJXP_USER",
"file.copy" => "Die Datei AJXP_NODE_LABEL wurde von AJXP_SOURCE_FOLDER nach AJXP_PARENT_PATH kopiert. AJXP_DATE, von AJXP_USER",
...
"folder.move" => "Der Ordner AJXP_NODE_LABEL wurde von AJXP_SOURCE_FOLDER nach AJXP_PARENT_PATH verschoben. AJXP_DATE, von AJXP_USER",
);
