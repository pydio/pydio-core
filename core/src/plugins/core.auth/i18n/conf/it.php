...
"Store Credentials in Session" => "Salva Credenziali nella Sessione",
"Authentification" => "Autenticazione",
"Options applied to all auth drivers" => "Opzione applicata a tutti i driver di autenticazione",
"Activate the users management system to protect your Pydio installation." => "Attiva il sistema di gestione degli utenti per proteggere la tua installazione di Pydio.",
"Case Sensitive" => "Case Sensitive",
"Whether the users identifiers should be case sensitive or not" => "Indica se gli identificatori utente debbano fare differenza tra lettere minuscole e maiuscole",
"Enable the 'guest' user, who does not need to log in." => "Abilita l'utente 'ospite', il quale non ha bisogno di effettuare l'accesso.",
"Minimum number of characters required for passwords in the application" => "Numero minimo di caratteri richiesto per le password dell'applicazione",
"Set the users credentials in the session after a successful login, this can be necessary when bridging specific auth and access plugins." => "Imposta le credenziali degli utenti in una sessione dopo aver effettuato il login con successo, questo potrebbe essere necessario con determinati plugin di accesso e autenticazione.",
...
"Action to trigger when clicking on Forgot Password" => "Azione da lanciare quando si clicca su Password Dimenticata",
