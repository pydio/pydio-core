...
"39"=> "Список пространств, которые Вам доступны. Они могут быть персональными или общие с другими людьми.",
...
"59"=> "iPhone/iPad",
    ...
    "64"=>"<h2>Совместное использование папок с APPLICATION_TITLE</h2>
                            Это видео представляет варианты использования общих папок с APPLICATION_TITLE
                            <ul>
                                <li>Новое общее рабочее пространство</li>
                                <li>Новый публичный общий мини-сайт</li>
            </ul>",
