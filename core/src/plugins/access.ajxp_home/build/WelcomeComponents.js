...
var HomeWorkspaceLegendPanel = React.createClass({displayName: "HomeWorkspaceLegendPanel",
    setWorkspace: function(ws){
        this.refs.legend.setWorkspace(ws);
    },
    render:function() {
        return (
            React.createElement("div", {id: "home_center_panel"}, 
                React.createElement("div", {id: "logo_div"}, React.createElement(ConfigLogo, {pydio: this.props.pydio, pluginName: "gui.ajax", pluginParameter: "CUSTOM_DASH_LOGO"})), 
...
var ConfigLogo = React.createClass({displayName: "ConfigLogo",
    render: function(){
...
var TutorialPane = React.createClass({displayName: "TutorialPane",
    ...
    render: function(){
        ...
        return (
            React.createElement("div", {id: "videos_pane", className: "skipSibling"}, 
                React.createElement("div", {onClick: this.closePane, className: "icon-remove-sign"}), 
                React.createElement("div", {className: "tutorial_title"}, MessageHash['user_home.56']), 
                React.createElement("div", {id: "tutorial_dl_apps_pane"}, 
                    React.createElement("div", {id: "dl_pydio_cont"}, 
                        React.createElement("div", {id: "dl_pydio_for"}, MessageHash['user_home.57']), 
                        React.createElement("div", {id: "dl_pydio_android"}, 
                            React.createElement("a", {href: configs.get('URL_APP_ANDROID'), target: "_blank", className: "icon-mobile-phone"}), React.createElement("a", {href: configs.get('URL_APP_ANDROID'), target: "_blank", className: "icon-android"}), React.createElement("div", null, MessageHash['user_home.58'])
                        ), 
                        React.createElement("div", {id: "dl_pydio_ios"}, 
                            React.createElement("a", {href: configs.get('URL_APP_IOSAPPSTORE'), target: "_blank", className: "icon-tablet"}), React.createElement("a", {href: configs.get('URL_APP_IOSAPPSTORE'), target: "_blank", className: "icon-apple"}), React.createElement("div", null, MessageHash['user_home.59'])
                        ), 
                        React.createElement("div", {id: "dl_pydio_mac"}, 
                            React.createElement("a", {href: configs.get('URL_APP_SYNC_MAC'), target: "_blank", className: "icon-desktop"}), React.createElement("a", {href: configs.get('URL_APP_SYNC_MAC'), target: "_blank", className: "icon-apple"}), React.createElement("div", null, MessageHash['user_home.60'])
                        ), 
                        React.createElement("div", {id: "dl_pydio_win"}, 
                            React.createElement("a", {href: configs.get('URL_APP_SYNC_WIN'), target: "_blank", className: "icon-laptop"}), React.createElement("a", {href: configs.get('URL_APP_SYNC_WIN'), target: "_blank", className: "icon-windows"}), React.createElement("div", null, MessageHash['user_home.61'])
                        )
                    )
                ), 
                React.createElement("div", {className: "tutorial_legend", "data-videosrc": "//www.youtube.com/embed/80kq-T6bQO4?list=PLxzQJCqzktEYnIChsR5h3idjAxgBssnt5"}, 
                    React.createElement("span", {dangerouslySetInnerHTML: htmlMessage('user_home.62')}), 
                    React.createElement("div", {className: "tutorial_load_button"}, React.createElement("i", {className: "icon-youtube-play"}), " Play Video")
                ), 
                React.createElement("img", {className: "tutorial_video", src: "https://img.youtube.com/vi/80kq-T6bQO4/0.jpg"}), 

                React.createElement("div", {className: "tutorial_legend", "data-videosrc": "//www.youtube.com/embed/ZuVKsIa4XdU?list=PLxzQJCqzktEYnIChsR5h3idjAxgBssnt5"}, 
                ...
                React.createElement("div", {className: "tutorial_legend", "data-videosrc": "//www.youtube.com/embed/MEHCN64RoTY?list=PLxzQJCqzktEYnIChsR5h3idjAxgBssnt5"}, 
                ...
                React.createElement("div", {className: "tutorial_legend", "data-videosrc": "//www.youtube.com/embed/ot2Nq-RAnYE?list=PLxzQJCqzktEYnIChsR5h3idjAxgBssnt5"}, 
                ...
                React.createElement("div", {className: "tutorial_more_videos_cont"}, 
                    React.createElement("a", {className: "tutorial_more_videos_button", href: "http://pyd.io/end-user-tutorials/", target: "_blank"}, React.createElement("i", {className: "icon-youtube-play"}), 
...
var HomeWorkspaceUserCartridge = React.createClass({displayName: "HomeWorkspaceUserCartridge",
    ...
    render: function(){
        ...
        if(this.props.controller.getActionByName("logout") && this.props.user.id != "guest"){
            ...
            loginLink = (
            React.createElement("small", null, parts[0], 
                React.createElement("span", {id: "disconnect_link", onClick: this.clickDisconnect}, 
                    React.createElement("a", null, this.props.controller.getActionByName("logout").options.text.toLowerCase())
                ), parts[1]
            )
            )
            ...
            loginLink = (
                React.createElement("small", null, 
                    "You can ", React.createElement("a", {id: "disconnect_link", onClick: this.clickConnect}, "login"), " if you are not guest."
                )
            )
        }
        ...
        if(this.props.enableGettingStarted){
            gettingStartedBlock = (
                React.createElement("small", null, React.createElement("span", {onClick: this.showGettingStarted}, MessageHash["user_home.55"].replace('<a>', '').replace('</a>','')))
            )
        }
...
var HomeWorkspacesList = React.createClass({displayName: "HomeWorkspacesList",
    ...
    render: function(){
        ...
        var titleNode = workspacesNodes.length? React.createElement("li", {className: "ws_selector_title"}, React.createElement("h3", null, MessageHash[468])) : '';
        var titleSharedNode = sharedNodes.length? React.createElement("li", {className: "ws_selector_title"}, React.createElement("h3", null, MessageHash[469])) : '';
        return (
            React.createElement("ul", {id: "workspaces_list"}, 
                titleNode, 
                workspacesNodes, 
                titleSharedNode, 
                sharedNodes
...
var HomeWorkspaceItem = React.createClass({displayName: "HomeWorkspaceItem",
    ...
    render: function(){
        ...
        return (
            React.createElement("li", {onMouseOver: this.onHoverLink, onMouseOut: this.props.onOutLink, onTouchTap: this.onClickLink, onClick: this.onClickLink, onDoubleClick: this.onDoubleClickLink}, 
                React.createElement("span", {className: "letter_badge"}, letters), 
                React.createElement("h3", null, this.props.ws.getLabel()), 
                React.createElement("h4", null, this.props.ws.getDescription())
            )
        )
    }
});

var HomeWorkspaceLegend = React.createClass({displayName: "HomeWorkspaceLegend",
    ...
    render: function(){
        ...
        if(data['core.users'] && data['core.users']['internal'] != undefined && data['core.users']['external'] != undefined){
            blocks.push(
                React.createElement(HomeWorkspaceLegendInfoBlock, {key: "core.users", badgeTitle: MessageHash[527], iconClass: "icon-group"}, 
                MessageHash[531], " ", data['core.users']['internal'], 
                React.createElement("br", null), MessageHash[532], " ", data['core.users']['external']
                )
            );
        }
        if(data['meta.quota']){
            blocks.push(
                React.createElement(HomeWorkspaceLegendInfoBlock, {key: "meta.quota", badgeTitle: MessageHash['meta.quota.4'], iconClass: "icon-dashboard"}, 
                parseInt(100*data['meta.quota']['usage']/data['meta.quota']['total']), "%", React.createElement("br", null), 
                    React.createElement("small", null, roundSize(data['meta.quota']['total'], MessageHash["byte_unit_symbol"]))
                )
            );
        }
        if(data['core.notifications'] && data['core.notifications'][0]){
            blocks.push(
                React.createElement(HomeWorkspaceLegendInfoBlock, {key: "notifications", badgeTitle: MessageHash[4], iconClass: "icon-calendar"}, 
        ...
        return (
            React.createElement("div", {id: "ws_legend"}, 
                this.state.workspace.getLabel(), 
                React.createElement("small", null, this.state.workspace.getDescription()), 
                React.createElement("div", {className: "repoInfo"}, 
                blocks
                ), 
                React.createElement("div", {style: {lineHeight: '0.5em'}}, 
                    React.createElement("input", {type: "checkbox", ref: "save_ws_choice", id: "save_ws_choice"}), 
                    React.createElement("label", {htmlFor: "save_ws_choice"}, MessageHash['user_home.41']), 
                    React.createElement("a", {onClick: this.enterWorkspace}, MessageHash['user_home.42'])
                )
            )
        )
    }
...
var HomeWorkspaceLegendInfoBlock = React.createClass({displayName: "HomeWorkspaceLegendInfoBlock",
    render:function(){
        return React.createElement("div", {className: "repoInfoBadge"}, 
            React.createElement("div", {className: "repoInfoTitle"}, 
...
var UserDashboard = React.createClass({displayName: "UserDashboard",
    ...
    render:function(){
        ...
        return (
            React.createElement("div", {className: "horizontal_layout vertical_fit"}, 
                React.createElement("div", {id: "home_left_bar", className: "vertical_layout"}, 
                    ...
                    React.createElement("div", {id: "workspaces_center", className: "vertical_layout vertical_fit"}, 
...
var WelcomeComponents = window.WelcomeComponents || {};
WelcomeComponents.UserDashboard = UserDashboard;
WelcomeComponents.TutorialPane = TutorialPane;
window.WelcomeComponents = WelcomeComponents;