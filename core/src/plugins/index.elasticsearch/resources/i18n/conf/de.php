...
"ElasticSearch Search Engine" => "ElasticSearch Suchmaschine",
...
"Set the maximum results that will be displayed." => "Die maximale Anzahl an Ergebnissen, die angezeigt werden.",
