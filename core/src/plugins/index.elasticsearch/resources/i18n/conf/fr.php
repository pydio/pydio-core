...
"ElasticSearch Search Engine" => "Moteur de recherche ElasticSearch",
"ElasticSearch implementation to index all files and search a whole repository quickly." => "Intégration de ElasticSearch pour indexer tous les fichiers et rechercher rapipdement dans l'intégralité d'un dépôt.",
"Max results displayed" => "Nombre de résultats affichés max.",
"Set the maximum results that will be displayed." => "Définir le nombre maximal de résultats qui seront affichés.",
