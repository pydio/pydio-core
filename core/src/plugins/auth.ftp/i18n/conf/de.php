...
"Workspace" => "Workspace",
"ID of the workspace used to validate credentials" => "ID des Workspace, der verwendet wird, um die Anmeldedaten zu prüfen",
"Admin user" => "Administrativer Benutzer",
"The ID of an existing admin for Pydio (using conf.serial)" => "Anmeldedaten eines Admin-Benutzers aus der Datei conf.serial.",
"Test connection" => "Verbindung testen",
"Test connection to the FTP server" => "Die Verbindung zum FTP-Server testen",
);