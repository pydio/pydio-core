...
*/
$mess=array(
"Serialized authentication storage" => "Serialisierter Speicher für Authentifikationsdaten",
"Stores the Authentication data as serialized PHP values on the filesystem." => "Speichert Authentifikationsdaten durch PHP serialisiert im Dateisystem.",
"Users" => "Benutzer",
