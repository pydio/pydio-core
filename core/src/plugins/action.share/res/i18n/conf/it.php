...
"Maximum share expiration limit for file, 0 = unlimited" => "Limite di scadenza massimo della condivisione, 0 = illimitato",
"Maximum file expiration limit" => "Limite massimo di scadenza del file",
"Maximum download limit for file, 0 = unlimited" => "Limite massimo di download per file, 0 = illimitato",
"Maximum file download limit" => "Limite massimo di download per file",
"Use external mailer for invitations" => "Utilizza un mailer esterno per gli inviti",
"Force External Mailer" => "Forza Mailer Esterno",
"Create and display QRCode for shared link" => "Crea e mostra QRCode per il collegamento condiviso",
...
"Autocomplete minimum chars" => "Numero minimo di caratteri per l'autocompletamento",
"Limit the number of results returned by the auto-completion feature when sharing a folder with other users" => "Limita il numero di risultati restituiti dall'autocompletamento quando si sta condividendo una cartella con altri utenti",
"Autocompletion results limit" => "Limite di risultati dell'autocompletamento",
"Mandatory prefix for users created temporary users login" => "Prefisso obbligatorio per i login di utenti temporanei creati da altri utenti",
"Tmp users prefix" => "Prefisso utenti temporaneo",
"Metadata Files" => "file Metadata",
"Weblink Page" => "Collegamento pagina web",
"Page Title" => "Titolo Pagina",
"Share page title. Use AJXP_FILENAME keyword to display the file name." => "Condividi titolo pagina. Utilizza la parola chiave AJXP_FILENAME per mostrare il nome del file.",
...
"Share page background color." => "Colore di sfondo della pagina Condividi.",
"Text Color" => "Colore del Testo",
"Share page text color." => "Colore del testo della pagina Condividi.",
"Text Shadow" => "Ombra Testo",
"Share page text shadow color." => "Colore del testo dell'ombra della pagina Condividi.",
"Page Background Images" => "Immagini di sfondo della Pagina",
"Custom Background (1)" => "Sfondo Personalizzato (1)",
"Image used as a background" => "Immagine utilizzata come sfondo",
...
"Top-right logo displayed on minisite page" => "Logo mostrato in alto a destra sulla pagina del mini sito",
);