...
"180" => "Limpiar lista",
"181" => "Modificar",
"182" => "Use el campo de arriba para elegir un usuario del directorio interno o de su libreta de direcciones. Si quiere crear un usuario nuevo escriba un identificador y pulse Enter.",
"183" => "Notificar cuando cambie el contenido",
"184" => "Notificar cuando se acceda o cambie",
"185" => "Notificar cuando se acceda",
"186" => "Notificar cuando cambie el contenido",
"187" => "No notificar",
"188" => "Recibir alertas cuando un usuario acceda o modifique el contenido compartido.",
"189" => "Activar enlace público",
"190" => "Este archivo no es accesible públicamente. Activar el enlace público crea un acceso único que puede mandar a quien quiera. Si quiere compartir con usuarios del directorio use la pestaña \"Usuarios\".",
"191" => "Copiar enlace al portapapeles",
"192" => "Enlace copiado al portapapeles",
"193" => "Personalizar enlace",
"194" => "Puede personalizar la última parte del enlace",
"195" => "Atención, no existe un visor para este archivo, a menos que se abra en una pestaña nueva, el usuario descargará el archivo automáticamente cuando acceda al enlace.",
"196" => "Acceso Seguro",
"197" => "Use este campo para enviar comentarios",
"198" => "Puede configurar la apariencia del enlace en su navegador.",
"199" => "Compartir Visibilidad",
"200" => "Visible para otros usuarios",
"201" => "Otros usuarios que accedan al workspace pueden configurar el enlace pero no eliminarlo. Sólo usted puede dejar de compartirlo o cambiar la visibilidad.",
"202" => "Otros usuarios que accedan al workspace pueden configurar el enlace. No es el propietario del contenido comaprtido y no puede borrarlo o cambiar su visibilidad.",
"203" => "Transferir Propiedad",
"203b"=> "Transferir",
"204" => "Si el enlace es visible públicamente y quiere que otro usuario gestione este elemento compartido puede transferir la propiedad.",
"205" => "Transferir a ... (identificador de usuario)",
"206" => "Los elementos compartidos son 'privados' por defecto: sólo usted puede verlos. Si quiere que otros usuarios tengan acceso al elementos compartido cambie la visibilidad.",
"207" => "Usuarios Remotos",
"208" => "Compartir con usuarios de otras plataformas (compatible con Federated Sharing API).",
"209" => "Dirección Remota",
"210" => "Identificador de Usuarios",
"211" => "pendiente",
"212" => "aceptado",
"213" => "rechazado",
"214" => "no enviado",
