...
"128" => "Core application parameters",
"129" => "Enable/disable additional feature-oriented plugins, check if they are correctly working, set up global parameters of the plugins.",
"130" => "Enable/disable core plugins (auth, conf, mail, etc), check if they are correctly working. Configuration of these plugins are generally done through the Main Options",
"131" => "Global configurations of the application core and of each plugin. Enable/disable plugins",
"132" => "Day-to-day administration of the application : who accesses to what, create roles, etc.",
"133" => "Create and delete workspaces, add features to them using meta sources.",
"134" => "Manage users and groups",
"135" => "Define profiles that can be applied at once to whole bunch of users.",
"136" => "Administrator tasks to monitor the application state.",
"137" => "Monitor all activities happening on the server",
"138" => "Read the start-up diagnostic",
"139" => "Developer Resources",
"140" => "Generated documentations for developers",
"141" => "Actions API",
"142" => "List all actions contributed by all plugins and visualize their input parameters",
"143" => "Hooks Definitions",
"144" => "List all hooks triggered in the application, their documentation, where there are triggered and which plugin listen to them.",
);
