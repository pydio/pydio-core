...
"93" => "Edition",
"94" => "Edition en masse",
"95" => "Choisir un libellé et un driver pour accéder aux données (vérifiez les différentes sections qui contiennent des champs obligatoires, vous pouvez passer la souris sur les labels pour avoir plus d'infos).",
