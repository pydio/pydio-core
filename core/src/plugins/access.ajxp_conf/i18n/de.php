...
"23" => "Test Name",
"24" => "Test Daten",
"25" => "Workspaces Zugriffe",
"26" => "Passwort ändern",
"27" => "Adminrechte",
"28" => "Benutzer hat Adminrechte?",
"29" => "Lesen",
"30" => "Schreiben",
"32" => "Workspace-Treiber",
"33" => "Lade...",
"34" => "Soll der Benutzer wirklich gelöscht werden? Dies kann nicht rückgängig gemacht werden!",
"35" => "Soll die Workspace wirklich gelöscht werden? Dies kann nicht rückgängig gemacht werden!",
...
"50" => "Fehler: Eine Workspace mit gleichen Namen existiert bereits",
"51" => "Das conf Verzeichnis ist nicht beschreibbar",
"52" => "Workspace erfolgreich erstellt",
"53" => "Fehler beim Ändern der Workspace",
"54" => "Workspace erfolgreich geändert",
...
"59" => "Workspace erfolgreich gelöscht",
...
"79" => "Workspace",
"80" => "Detaillierter Zugriff für diesen Benutzer  (Click on a Workspace label if you wish to make it the default Workspace when user logs in)",
"81" => "Typische Workspace Inhalte",
...
"88" => "Diese Workspace wurde in der Config-Datei angelegt, über das GUI können die Quellen für die Meta-Daten nicht aktualisiert werden.",
...
"110" => "Workspaces & Benutzer",
"111" => "Logs & Andere Daten",
"112" => "<b>Diese Rolle als Standard für alle Benutzer festlegen</b>",
