...
*/
$mess=array(
"Image viewer" => "Visualizzatore immagine",
"Image viewer, used for previewing images and browsing them in a diaporam. Generates a thumbnail version of the images." => "Visualizzatore immagine, utilizzato per l'anteprima delle immagini e la navigazione di esse in diaporam. Genera immagini in versione miniatura.",
