...
$mess = array(
    ...
    "3" => "m",
    "4" => "Entrez une ou plusieurs adresses HTTP de fichiers que vous voulez télécharger. Cette action sera effectuée en arrière-plan et vous pourrez continuer à utiliser APPLICATION_TITLE pendant ce temps.",
    "5" => "URL",
    "6" => "Chargement",
    "7" => "sur le serveur",
    "8" => "Fichier téléchargé, rechargement du client!",
    "9" => "Générer le bookmarklet",
    "10"=> "Envoyer sur APPLICATION_TITLE",
    "10a"=> "Envoyer dans %s",
    "10b"=> "Env. dans %s",
    "10c"=> "Env. dans %s",
