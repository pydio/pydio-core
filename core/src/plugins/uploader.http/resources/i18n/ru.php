...
$mess = array(
    ...
    "9" => "Сгенерировать закладки",
    "10"=> "Загрузить в APPLICATION_TITLE",
    "10a"=> "Загрузить в  %s",
    "10b"=> "DL to %s",
    "10c"=> "DL to %s",
    "10d"=> "AjXp Download (%s)",
    "11"=> "Перетащите одну из ссылок в ваши закладки : ",
    "12"=> "Trigger remote file download",
    "13"=> "С компьютера",
    "14"=> "С другого сервера",
    "15"=> "Или создайте закладки вручную, использовав приведённый код как ссылку (URL) : ",
    "16"=> "Перетащи меня в закладки!",
    "17"=> "Загрузить файл",
    "18"=> "Partial file"
);
