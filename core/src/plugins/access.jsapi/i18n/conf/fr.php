...
"Browse Pydio Javascript classes and interfaces. Helper for developpers, but also good demonstration of how Pydio data can be fed by something different than a remote server filesystem!" => "Lister les classes et les interfaces javascript de Pydio. Pratique non seulement pour les développeurs, mais également une démonstration du fait que Pydio peut-être alimenté par autre chose qu'un système de fichier distant !",
);
