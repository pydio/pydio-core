...
*/
$mess=array(
"Basic Http by Server" => "Standard-HTTP (Server)",
"Basic Http Auth performed by server (e.g. apache htaccess)" => "Über Standard-HTTP des Servers authentifizieren. (z.B. durch Apache htaccess)",
...
"Automatically set this login as pydio administrator" => "Diesen Benutzer automatisch als Pydio Administrator festlegen",
