...
"Name that users will see" => "Namen den die BenutzerInnen sehen",
...
"How the application configuration data will be stored (users, plugins, etc. &lt;b&gt;not&lt;/b&gt; how your actual documents are managed). To get started rapidly, select No Database. To enable more advanced features, configure a database connection." => "Wie die Konfigurationsdaten der Anwendung gespeichert werden (Benutzer, Plugins, etc. &lt;b&gt;nicht&lt;/b&gt; wie Dokumente abgelegt werden). Der Modus ohne Datenbank ist für einen schnellen Test des Systems, nicht aber für den Produktivbetrieb gedacht. Dort sollte immer eine Datenbank bevorzugt werden (sqlite benötigt keinen zusätzlichen Dienst).",
