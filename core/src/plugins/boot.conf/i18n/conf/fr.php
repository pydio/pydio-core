...
"Database (production environments, requires a DBMS supported by APPLICATION_TITLE)" => "Base de données (environnements productifs, nécessite un SGBD compatible avec APPLICATION_TITLE)",
