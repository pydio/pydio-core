...
"Add a secure token to the target script to make sure that we are downloading an authorized image. The .htaccess file contained in the plugin must be correctly configured (apache)" => "Fügen Sie einen Secure-Token hinzu. Damit sind Sie autorisiert, Bilder herunterzuladen. Die in der Erweiterung enthalte htaccess-Datei muss korrekt konfiguriert werden (Apache).",
