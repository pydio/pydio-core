...
$mess = array(
    "1" => "Action",
    "1d" => "Action que cette tâche doit effectuer",
    "2" => "Planification",
    "2d" => "Expression de type Crontab au format suivant : minutes heures jours joursDeSemaine mois. Vous pouvez utiliser des jokers (*), des pas (,) et des intervalles (-).",
