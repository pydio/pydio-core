...
"11"=> "¿Estás seguro que quieres borrar los elemento selecionados?",
...
"27"=> "Dueño",
"28"=> "Archivos compartidos para descargas directas, con o sin contraseña.",
...
"title" => "Mi Cuenta",
"desc" => "Administrar las preferencias de la cuenta, libreta de direcciones, elementos compartidos, etc.",
"34" => "Mis elementos compartidos",
"35" => "Todos mis elementos compartidos (archivos y carpetas)",
"36" => "Parámetros",
"37" => "Mi perfil y configuraciones de la aplicación",
"38"=> "Notificaciones",
"39"=> "Seleccione un Espacio de Trabajo",
"40"=> "Bienvenido, %s",
"41"=> "Utilizar este Espacio de Trabajo como predeterminado",
"42"=> "Entrar",
"43"=> "Mi Perfil",
...
"50"=> "Mis Equipos",
"51"=> "Equipos de usuarios, utilizados como abreviación al compartir",
"52"=> "¿Está seguro que desea eliminar este equipo? Esto no eliminará ningún usuario.",
    "53"=> "Volver a mis Espacios de Trabajo",
    "54"=> "Actualizar miembros",
    "55"=> "Agregar/Eliminar usuarios de este equipo",
    "56"=> "Agregue un usuario por línea, escriba en el área de texto para ver la lista de autocompletar",
);
