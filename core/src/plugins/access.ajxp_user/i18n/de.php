...
"29"=> "Repository von delegierten Benutzern.",
"30"=> "Mit delegierten Repository verknüpfte Benutzer.",
"31"=> "Beschreibung",
"32"=> "Zurücksetzen",
...
"40"=> "Willkommen, %s",
"41"=> "Dieses Repository standardmäßig verwenden",
"42"=> "Betreten",
"43"=> "Mein Profil",
...
"53"=> "Zurück zu meinen Repositorys",
);