...
"User quota" => "Speicherverbrauch pro Benutzer",
"Maintain the size of a given directory for each user" => "Maximaler Speicherplatz, den ein Benutzer maximal belegen darf.",
);
