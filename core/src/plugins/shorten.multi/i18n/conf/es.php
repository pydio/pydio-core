...
"adF.ly account user ID. The numbers after -= ?id= =- in of your referral program's URL" => "ID de usuario de tu cuenta de adF.ly.\nLos numeros tras el -= ?id= =- en tu URL del 'referral program'",
"API Key" => "Clave de API",
"adF.ly account API Key" => "Clave de API de tu cuenta de adF.ly",
"Type of ADS" => "Tipo de anuncio",
"Type of AD you like to show. Select Fullscreen AD or Top banner AD" => "Tipo de Anuncio que quieres usar.\nSelecciona Pantalla completa o Marco superior",
