...
"Public Base URI" => "URI Liens Publics",
"URI where to serve the public links" => "Base de l'URI pour l'accès aux liens publics",
"Enable for all users" => "Activer pour tous les utilisateurs",
"Enable WebDAV for all users by default. If set to false, users will have to manually enable WebDAV via their preferences panel." => "Activer WebDAV pour tous les utilisateurs. Si ce n'est pas le cas, les utilisateurs devront manuellement l'activer dans leur profil.",
"Download Delegation" => "Download Delegation [exp]",
...
"Core Connexion" => "Base de données",
);
