...
"Prefilled label for the new repository, you can use the AJXP_USER keyworkd in it." => "Libellé pré-rempli pour le nouveau dépôt, vous pouvez utiliser AJXP_USER.",
...
"Auto Create User" => "Auto-création Utilisateur",
