...
"Allow the users to pick an existing user when sharing a folder" => "Permitir a los usuarios escoger un usuario existente cuando se comparte un directorio.",
...
"Maximum characters length of new files or folders" => "Número máximo de caracteres de archivos o directorios nuevos",
...
"Recycle Bin Folder" => "Directorio de Papelera de Reciclaje",
...
"When a folder will contain more items than this number, display will switch to pagination mode, for better performances." => "Cuando un directorio contiene más elementos que este límite, se cambia a modo paginación para un mejor rendimiento.",
...
"Comma separated list of metastore and meta plugins, that will be automatically applied to all repositories created with this driver" => "Lista de metastore y metaplugins separados por comas, se aplicará automáticamente a todos los workspaces creados con este driver",
"Auth Driver Commons" => "Drivers de Autenticación",
...
"For exotic auth drivers, an user ID that must be considered as admin by default." => "Para algunos drivers de autenticación, la ID de usuario que tiene que ser considerado como administrador por defecto.",
"Show hidden files" => "Mostrar archivos ocultos",
"Show files beginning with a ." => "Muestra archivos que comienzan con .",
"Hide recycle bin" => "Ocultar papelera de reciclaje",
"Whether to show the recycle bin folder. Unlike in the following options, the folder will be hidden but still writeable." => "Mostrar u ocultar la papelera de reciclaje. Sin depender de esta opción, el directorio puede estar oculto pero permanece con permisos de escritura.",
"Hide extensions" => "Ocultar extensiones",
"Comma-separated list of extensions to hide. Extensions, files and folders that are hidden are also access forbidden." => "Lista de extensiones a ocultar separadas por comas. Las extensiones, archivos y directorios ocultos tienen también el acceso restringido.",
"Hide folders" => "Ocultar directorios",
"Comma-separated list of specific folders to hide" => "Lista de directorios a ocultar separados por comas",
...
"Display the list of files and folder when accessing through the browser" => "Mostrar lista de archivos y directorios cuando se accede desde el navegador.",
...
"For multiple authentication, apply this role to users authenticated via this driver" => "Para autenticación multiple, aplicar este rol a los usuarios autenticados mediante este driver",
"DSN" => "DSN",
...
"Driver" => "Driver",
"Driver type (do not touch)" => "Tipo de Driver (no tocar)",
