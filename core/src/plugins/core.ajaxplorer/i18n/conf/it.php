...
"Compression Features" => "Funzionalit&agrave; di compressione",
...
"User" => "Utente",
"User name - Can be overriden on a per-user basis (see users 'Personal Data' tab)" => "Nome utente - Pu&ograve; essere sovrascritto da ogni utente (vedi tab 'Dati Personali')",
"Password" => "Password",
"User password - Can be overriden on a per-user basis." => "Password utetne - Pu&ograve; essere sovrascritta da ogni utente.",
...
"This right pattern (empty, r, or rw) will be applied at user creation for this repository." => "Questo pattern di permessi (vuoto, r, or, rw) verr&agrave; applicato durante la creazione di utenti per questa repository.",
"Character Encoding" => "Codifica Caratteri",
"If your server does not set correctly its charset, it can be good to specify it here manually." => "Se il tuo server non imposta correttamente il charset, pu&ograve; essere utile specificarlo manualmente qui.",
"Pagination Threshold" => "Soglia Paginazione",
"When a folder will contain more items than this number, display will switch to pagination mode, for better performances." => "Quando una cartella contiene pi&ugrave; utenti del numero qui specificato, verr&agrave; mostrata una paginazione, per migliorare le prestazioni.",
...
"If set to a given URL, the login action will not trigger the display of login screen but redirect to this URL." => "Se impostato ad un URL. l'azione di login non mostrer&agrave; la pagina di login, ma reindirizzer&agrave; a questo URL.",
...
"Whether to show the recycle bin folder. Unlike in the following options, the folder will be hidden but still writeable." => "Indica se mostrare o meno la cartella del cestino. Diversamente dalle seguenti impostazioni, la cartella sar&agrave; nasconsta ma ancora scrivibile.",
...
"Server URL used to build share links and notifications. It will be detected if empty." => "URL del server utilizzato per creare i collegamenti condivisi e le notifiche. Sar&agrave; trovato dal sistema se lasciato vuoto.",
"Force Basic Auth" => "Forza Autenticazione di Base",
"This authentication mechanism is less secure, but will avoid the users having to re-enter a password in some case." => "Questo meccanismo &egrave; meno sicuro, ma eviter&agrave; di far reinserire la password in alcuni casi.",
...
"On Windows running IIS, set this option to true if the COM extension is loaded, this may enable the use of the php command line." => "Su Windows con IIS imposta questa opzione se l'estensione COM &egrave; caricata, potrebbe abilitare l'utilizzo di php da linea di comando.",
