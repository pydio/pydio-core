...
"Download Folder (Legacy)" => "Download Cartella (Legacy)",
"Absolute path to the public folder where temporary download links will be created. This is used for legacy purpose, newly created links do not use it anymore, but use the Base URI instead." => "Percorso assoluto alla cartella pubblica dove i link di download vengono temporaneamente creati. È usato per motivi di compatibilità (legacy). I nuovi link creati non ne fanno uso, perchè utilizzano il Base URI.",
"Download URL" => "URL Download",
"If not inferred directly from the current pydio URL plus the public base URI, replace the public access URL here." => "Se non direttamente dedotto dall'URL corrente di Pydio più il base URI pubblico, sostituire l'URL per l'accesso pubblico.",
...
"Public Base URI" => "Base URI Pubblico",
"URI where to serve the public links" => "URI al quale servire i link pubblici",
"Enable for all users" => "Abilita per tutti gli utenti.",
"Enable WebDAV for all users by default. If set to false, users will have to manually enable WebDAV via their preferences panel." => "Abilita il WebDAV per tutti gli utenti di default. Se negativo, gli utenti dovranno abilitare manualmente il WebDAV attraverso il loro pannello delle preferenze.",
"Download Delegation" => "Delega Download",
"Delegates download operations to an alternative agent, either webserver or pydio agent. Warning, this requires external modules to be installed. When using XSendFile/XaccelRedirect, you have to manually add the folders where files will be downloaded in the module configuration" => "Delega le operazioni di download ad un agent alternativo, sia il webserver o l'agent di pydio. ATTENZIONE: questo richiede l'installazione di moduli esterni. Quando si usa XSendFile/XaccelRedirect, bisogna aggiungere manualmente le cartelle dove i file verranno scaricati nella configurazione del modulo.",
"Core Connexion" => "Connessione principale",
);
