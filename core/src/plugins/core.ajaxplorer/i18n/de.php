...
/*******************************************************************************
* German translation:
* Philip Sch&auml;dler <philip.schaedler@gmail.com>
*  	+ update: Axel Otterst&auml;tter <axel.otterstaetter@googlemail.com>
...
"29" => "Erstellen",
"30" => "Bitte einen Namen f&uuml;r das Verzeichnis eingeben und auf &quot;Erstellen&quot; klicken.",
...
"40" => "Dieses Verzeichnis existiert bereits (Gross- und Kleinschreibung wird nicht beachtet)",
...
"68" => "Einf&uuml;gen in",
"69" => "oder ein anderes Verzeichnis w&auml;hlen",
"70" => "Verschieben",
...
"99" => "kann nicht gespeichert werden. Dies k&ouml;nnte ein Berechtigungsproblem sein, wenden Sie sich an den Systemadministrator.",
...
"152"=> "Lesezeichen",
"153"=> 'Aktuelles Verzeichnis zu "Meine Lesezeichen" hinzuf&uuml;gen',
"154"=> "Neuer Ordner",
...
"336" => "Es k&ouml;nnen nur Dateien, keine Verzeichnisse abgelegt werden!",
...
"348" => "Ein neuer Workspace wurde freigegeben.",
...
"352" => "Ein Workspace mit diesem Namen existiert bereits. Bitte w&auml;hlen Sie einen anderen Namen.",
"353" => "Ziel-Benutzer",
...
"366" => "Dieser Benutzer hat keine aktive Workspaces.",
...
"372" => "Aktueller Workspace",
"373" => "Ziel",
"374" => "Ordner k&ouml;nnen nicht zwischen Workspaces kopiert werden",
"375" => "Achtung, inaktivit&auml;t seit mehr als __IDLE__, ein automatischer Logout erfolgt nach __LOGOUT__",
...
"394" => "Entschuldigung, aber zur Zeit ist das Teilen der Verzeichnisse (sharing) aufgrund des aktuellen Authentifizierungstreiber nicht m&ouml;glich (Benutzer k&ouml;nnen nicht ver&auml;ndert werden). Aber das Datei-Sharing funktioniert.",
"395" => "Das fallengelassene Element scheint ein Ordner zu sein, aber Verzeichnisse k&ouml;nnen nicht zum Server hochgeladen werden! Soll der Upload trotzdem gestartet werden?",
"396" => "Auth. Methode",
"397" => "Download segmentiert",
"398" => "Download der ausgew&auml;hlten Dateien in einzelnen Segmenten",
"399" => "Geben Sie die Anzahl der Dateisegmente an, klicken Sie auf den Knopf und w&auml;hlen Sie die entsprechende Datei zum Download aus.",
"400" => "Anzahl der Segmente:",
"401" => "Laden Sie die folgende Software herunter und installieren Sie sie, um die einzelnen Segmente zusammen zuf&uuml;gen: ",
"402" => "http://www.hjsplit.org/",
"403" => "WebDAV Voreinstellungen",
"404" => "Das WebDAV-Protokoll kann verwendet werden, um die APPLICATION_TITLE Arbeitsumgebung als 'Netzwerklaufwerk' unter Windows, Mac, iPhone usw. zu nutzen.",
"405" => "Nutzen Sie die folgenden URLs um auf die Arbeitsumgebung mit ihrem eingegebenen Benutzernamen und Passwort zuzugreifen. Achtung, die Freigabe arbeitet nur, wenn diese auf 'Aktiv' gesetzt ist und das Passwort eingegeben wurde.",
...
"423" => "Workspace l&ouml;schen",
"424" => "Workspace wirklich l&ouml;schen? Das L&ouml;schen kann nicht r&uuml;ckg&auml;ngig gemacht werden.",
"425" => "Der Workspace wurde erstellt und ihrer Workspace-Liste hinzugef&uuml;gt. Falls es wieder gel&ouml;scht werden soll, zun&auml;chst zu einer anderer Arbeitsumgebung wechseln und dann auf das rote Kreuz neben dem Namen der Arbeitsumgebung klicken.",
"426" => "Es ist ein Fehler beim Erstellen des Workspaces aufgetreten.",
"427" => "Es ist ein Fehler beim L&ouml;schen des Workspace aufgetreten.",
"428" => "Die Arbeitsumgebung wurde gel&ouml;scht.",
"429" => "Dies gibt an, wie der Workspace in der Liste dargestellt wird.",
...
"435" => "fertig",
"436" => "Fehler",
"437" => "Oh, es scheint, dass das Sicherheitstoken abgelaufen ist! Bitte %s durch dr&uuml;cken von Neuladen oder F5 im Browser!",
...
"454" => "W&auml;hlen Sie die Dateien auf Ihren PC",
"455" => "Meine Workspaces",
"456" => "Mehr",
"457" => "update",
"458" => "l&ouml;schen",
"459" => "Hauptordner",
...
"464" => "Alle Arbeitsumgebungen Inhalte auf einmal herunterladen (gezippt)",
"465" => "Zeigen alternative URLs (momentane Arbeitsumgebungen)",
"466" => "Lade...",
"467" => "Alle geteilten Inhalte",
"468" => "Meine Workspaces",
"469" => "Mit mir Geteilt",
"470" => "Erstellt %date",
...
"475" => "F&uuml;r alle Benutzer freigegeben",
"476" => "Ihre pers&ouml;hnliche Arbeitsumgebung",
...
"508" => "Wir erstellten ein Konto f&uuml;r dich bei %s. Um sich zu verbinden bitte folgenden Link klicken %link und mit diesen Zugangsdaten einloggen:  <br><br> Login: %user <br><br> Passwort: %pass",
"509" => "Aktuelle Benutzerliste als pers&ouml;hnliches Team speichern",
