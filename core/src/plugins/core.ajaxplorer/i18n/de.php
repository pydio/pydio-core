...
"352" => "Ein Workspace mit diesem Namen existiert bereits. Bitte wählen Sie einen anderen Namen.",
"353" => "Ziel-Benutzer",
...
"418" => "Eigenen Workspace erstellen",
"419" => "Lade Vorlagen...",
"420" => "Vorlagen",
"421" => "Neu %s",
...
"425" => "Der Workspace wurde erstellt und ihrer Workspace-Liste hinzugefügt. Falls es wieder gelöscht werden soll, zunächst auf einen anderen Workspace wechseln und dann auf das rote Kreuz neben dem Repository-Namen klicken.",
"426" => "Es ist ein Fehler beim Erstellen des Workspaces aufgetreten.",
"427" => "Es ist ein Fehler beim Löschen des Workspace aufgetreten.",
