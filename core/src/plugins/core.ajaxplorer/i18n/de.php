...
"348" => "Eine neue Workspace wurde freigegeben.",
...
"352" => "Eine Workspace mit diesem Namen existiert bereits. Bitte wählen Sie einen anderen Namen.",
"353" => "Ziel-Benutzer",
...
"366" => "Dieser Benutzer hat keine aktiven Workspaces.",
...
"372" => "Aktuelle Workspace",
"373" => "Ziel",
"374" => "Ordner können nicht zwischen Workspaces kopiert werden",
...
"404" => "Das WebDAV-Protokoll kann verwendet werden, um die APPLICATION_TITLE Workspaces als 'Netzwerklaufwerk' unter Windows, Mac, iPhone usw. zu nutzen.",
"405" => "Nutzen Sie die folgenden URLs um auf die Workspaces mit ihrem eingegebenen Benutzernamen und Passwort zu zugreifen. Achtung, die Freigabe arbeitet nur, wenn diese auf 'Aktiv' gesetzt ist und das Passwort eingegeben wurde.",
...
"417" => "Workspaces hinzufügen...",
"418" => "Eigene Workspace erstellen",
"419" => "Lade Vorlagen...",
"420" => "Vorlagen",
"421" => "Neu %s",
...
"423" => "Workspace löschen",
"424" => "Workspace wirklich löschen? Das Löschen kann nicht rückgängig gemacht werden.",
"425" => "Die Workspace wurde erstellt und Ihrer Workspace-Liste hinzugefügt. Falls es wieder gelöscht werden soll, zunächst auf eine andere Workspace wechseln und dann auf das rote Kreuz neben dem Workspace-Namen klicken.",
"426" => "Es ist ein Fehler beim Erstellen des Workspaces aufgetreten.",
"427" => "Es ist ein Fehler beim Löschen des Workspaces aufgetreten.",
"428" => "Der Workspace wurde gelöscht.",
"429" => "Dies gibt an, wie die Workspace in der Liste dargestellt wird.",
...
"464" => "Alle Workspaces Inhalte auf einmal herunterladen (gezippt)",
"465" => "Zeigen alternative URLs (momentane Workspaces)",
"466" => "Lade...",
...
"504" => "1k,1M,1G",
"505" => "bis",
"506" => "Einstellungen der Anwendung (Benutzer, Workspaces, Konfigurationen)",
...
"531"=> "Int.",
"532"=> "Ext.",
"plugtype.title.access" => "Workspace Treiber",
