...
"23" => "Datei",
"24" => "Aufwärts",
"25" => "Eine oder mehrere Dateien (max. ".Pydio\Conf\Core\ConfService::getConf('UPLOAD_MAX_NUMBER').") in folgenden Ordner hochladen: ",
...
"543" => "Es werden nur die ersten 100 von %s Ergebnissen angezeigt.",
"544" => "Alle anzeigen",
