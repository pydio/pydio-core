...
"404" => "Das WebDAV-Protokoll kann verwendet werden, um die APPLICATION_TITLE Repositories als 'Netzwerklaufwerk' unter Windows, Mac, iPhone usw. zu nutzen.",
...
"420" => "Templates",
"421" => "Neu %s",
"422" => "Bitte die erforderlichen Parameter angeben. Mit der Maus über die Titel fahren, für weitere Informationen.",
"423" => "Repository löschen",
"424" => "Repository wirklich löschen? Das Löschen kann nicht Rückgängig gemacht werden.",
"425" => "Das Repository wurde erstellt und ihrer Repository-Liste hinzugefügt. Falls es wieder gelöscht werden soll, zunächst auf ein anderes Repository wechseln und dann auf das rote Kreuz neben dem Repository-Namen klicken.",
"426" => "Es ist ein Fehler beim Erstellen des Repositories aufgetreten.",
...
"504" => "1k,1M,1G",
"505" => "bis",
"506" => "Einstellungen der Anwendung (Benutzer, Repositories, Konfigurationen)",
