...
"299" => "Neues Repository.",
"300" => "Neues Repository anlegen",
...
"352" => "Ein Repository mit diesem Namen existiert bereits. Bitte wählen Sie einen anderen Namen.",
"353" => "Ziel-Benutzer",
...
"366" => "Dieser Benutzer hat keine aktive Repositorys.",
...
"373" => "Ziel",
"374" => "Ordner können nicht zwischen Repositorys kopiert werden",
...
"404" => "Das WebDAV-Protokoll kann verwendet werden, um die APPLICATION_TITLE Repositorys als 'Netzwerklaufwerk' unter Windows, Mac, iPhone usw. zu nutzen.",
"405" => "Nutzen Sie die folgenden URLs um auf die Repositorys mit ihrem eingegebenen Benutzernamen und Passwort zu zugreifen. Achtung, die Freigabe arbeitet nur, wenn diese auf 'Aktiv' gesetzt ist und das Passwort eingegeben wurde.",
...
"417" => "Repository hinzufügen...",
"418" => "Eigenes Repository erstellen",
"419" => "Lade Vorlagen...",
"420" => "Vorlagen",
"421" => "Neu %s",
...
"423" => "Repository löschen",
"424" => "Repository wirklich löschen? Das Löschen kann nicht rückgängig gemacht werden.",
"425" => "Das Repository wurde erstellt und Ihrer Repository-Liste hinzugefügt. Falls es wieder gelöscht werden soll, zunächst auf einen anderen Repository wechseln und dann auf das rote Kreuz neben dem Repository-Namen klicken.",
"426" => "Es ist ein Fehler beim Erstellen des Repositorys aufgetreten.",
"427" => "Es ist ein Fehler beim Löschen des Repository aufgetreten.",
"428" => "Der Repository wurde gelöscht.",
...
"454" => "Dateien auf PC auswählen",
"455" => "Meine Repositorys",
"456" => "Mehr",
"457" => "update",
"458" => "löschen",
"459" => "Hauptordner",
...
"464" => "Alle Repositorys Inhalte auf einmal herunterladen (gezippt)",
"465" => "Zeigen alternative URLs (momentane Repositorys)",
"466" => "Lade...",
"467" => "Alle geteilten Inhalte",
"468" => "Meine Repositorys",
"469" => "Mit mir Geteilt",
"470" => "Erstellt %date",
...
"504" => "1k,1M,1G",
"505" => "bis",
"506" => "Einstellungen der Anwendung (Benutzer, Repositorys, Konfigurationen)",
...
"531"=> "Int.",
"532"=> "Ext.",
"plugtype.title.access" => "Repository Treiber",
