...
"369" => "Atalho",
"370" => "Transferência Público do Pydio",
...
"390" => "Código",
"391" => "Sem Repositório",
"392" => "ATENÇÃO: A versão do Pydio foi alterada (agora é %s), por favor limpe a cache do seu Navegador e actualize a página para se certificar de que tudo continua a funcionar correctamente!",
