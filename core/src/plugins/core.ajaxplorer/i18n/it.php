...
"531"=> "Utenti",
"532"=> "Gruppi",
"533" => "Identificativo usato per il login. Utilizzare caratteri minuscoli alfanumerici o per e-mail.",
"534" => "Password usata per il login",
"535" => "Invia password per e-mail",
"536" => "Invia un'e-mail di benvenuto al nuovo utente includendo la password",
...
"plugtype.desc.cache" => "Unico plugin per impostare il cache server usato dall'applicazione",
...
"plugtype.title.sec" => "Sicurezza",
"plugtype.desc.sec" => "Funzionalità di sicurezza avanzate",
"plugtype.title.helper" => "Helper",
"plugtype.desc.helper" => "Strumenti di supporto per i compiti amministrativi",
...
"546" => "Questo elemento è stato condiviso con te da %%OWNER%% da una posizione remota. Vuoi continuare?",
"547" => "Accetto",
"548" => "Rifiuto",
"549" => "Hai precedentemente accettato questo elemento che era stato condiviso con te da %%OWNER%% da una posizione remota. Vuoi rifiutare ora?",
"550" => "Rifiuta questa condivisione",
"551" => "Rifiuta",
"552" => "Inserire la password.",
"553" => "Password non valida. Riprovare.\\n Assicurati che il Bloc-Maiusc non sia attivato!",
"554" => "%s risultato/i nel Cestino",
"556" => "Avvia processo %s in background",
"557" => "Credenziali richieste",
"558" => "Inserire una password per accedere a questo workspace.",
"559" => "Autenticazione fallita per questo workspace.",
"560" => "Autenticazione richiesta.",
"561" => "Verrai reindirizzato alla pagina di autenticazione del fornitore. Se non avviene automaticamente, premi OK per riprovare...",
"react.1" => "cartella superiore",
"react.2" => "azioni in blocco",
"375t" => "Sei ancora lì?",
"562" => "Questa cartella è vuota!",
"563" => "Questo workspace è vuoto!",
"564" => "Il cestino è vuoto.",
"565" => "Inizia ad aggiungere file e cartelle selezionandole o trascinandole direttamente dal tuo desktop",
"566" => "Non sei autorizzato ad aggiungere file quì",
"567" => "Apri il cestino",
"568" => "I miei Team",
"569" => "Nuovo Team",
"570" => "Cancella Team",
"571" => "Nessun team creato",
"572" => "Crea i tuoi team personali per condividere facilmente con più utenti",
"573" => "Aggiungi un utente al team",
"574" => "Rimuovi dal team",
"575" => "Membri Team",
"576" => "%s membri",
"577" => "Nessun membro",
"578" => "Nome Team",
"579" => "Crea Team",
"580" => "Modifica nome team",
"581" => "L'utente appartiene ai team %s",
"582" => "Cancella utente",
"583" => "Cerca Cartella",
"584" => "Cartella",
"585" => "Nessun Utente Esternop",
"586" => "Crea i tuoi utenti e condividi con loro file e cartelle dai tuoi workspaces.",
"587" => "Nessun risultato",
"588" => "Inizia a digitare nel campo di ricerca per trovare gli utenti nella cartella",
"589" => "Utente esterno",
"590" => "Utente interno",
"591" => "Scegli un nome per il team; sarai in grado di aggiungerervi utenti dopo la creazione.",
"592" => "Rubrica",
"593" => "I miei utenti",
"594" => "Server Certificati",
"595" => "Cerca utente...",
"596" => "Server '%s'",
"597" => "tutti",
"598" => "Invia un messaggio",
"599" => "Aggiungi un utente",
"600" => "Modifica utente",
"601" => "%1 ha condiviso %2 elementi con te.",
"602" => "Hai condiviso %2 elementi con %1.",
"603" => "Team",
"604" => "Utente Remoto",
"605" => "Più opzioni di ricerca",
"606" => "Meno opzioni di ricerca",
"607" => "Cerca all'interno di tutti i workspaces",
"608" => "Cartella corrente",
"609" => "Tutto il workspace",
"610" => "Tutti i worskpace",
"611" => "Inizia a digitare per cercare",
"612" => "Intervallo personalizzato",
"613" => "Maggiore di...",
"614" => "Minore di...",
"615" => "Esegui",
"616" => "Maschera",
"617" => "Vai",
"618" => "Cambia lingua...",
"619" => "Cerca limitatamente alla cartella corrente ed ai suoi figli",
"620" => "Cerca limitatamente al workspace corrente",
"621" => "Questo campo non può essere vuoto",
"622" => "Errori",
"623" => "Copia",
"624" => "Copiato!",
"625" => "Lettera",
"626" => "File Condivisi con me",
"627" => "Condivisioni da server remoti",
"628" => "Annulla",
"629" => "Nessun record",
"630" => "Cartelle condivise con me",
/* END SENTENCE */
);