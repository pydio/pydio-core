...
"392" => "Attenzione, la versione di Pydio è cambiata (ora %s), per favore pulisci la cache del tuo browser e aggiorna la pagina per essere sicuro che tutto funzioni correttamente!",
...
"483" => "Attualmente non sei autorizzato a creare più utenti!",
"484" => "Crea utente",
