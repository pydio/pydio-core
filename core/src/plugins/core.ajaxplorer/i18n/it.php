...
"468" => "I Miei Spazi di lavoro",
"469" => "Condivisi con me",
"470" => "Creato il %date",
"471" => "Creato da %user il %date",
"472" => "Condiviso da %user",
"473" => "Condiviso da %user il %date",
"474" => "Nessuna descrizione disponibile",
"475" => "File condivisi con tutti gli utenti",
"476" => "Il tuo spazio di lavoro personale",
"477" => "Seleziona un file o una cartella per vederne i dettagli",
"478" => "Nessun risultato trovato",
"479" => "Password dimenticata?",
"480" => "Naviga tutte le cartelle dello spazio di lavoro attuale.",
"481" => "Tutti i tuoi file e cartelle condivise",
"482" => "Accedi velocemente agli elementi aggiunti ai tuoi segnalibri",
"483" => "Attualmente non sei autorizzato a creare pi&ugrave; utenti!",
"484" => "Crea utente",
...
"504" => "1k,1M,1G",
"505" => "a",
"506" => "Parametri applicazione (utenti, spazi di lavoro, configurazioni)",
"507" => "Benvenuto in %s",
"508" => "Ho appena creato un account per te su %s. Per connetterti, clicca sul collegamento seguente %link ed utilizza queste credenziali:  <br><br> Login: %user <br><br> Password: %pass",
"509" => "Salva la lita degli utenti attuale come team personale",
"510" => "Per favore inserisci un'etichetta per il team",
"511" => "Mio %s",
/* END SENTENCE */
);