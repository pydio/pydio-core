...
"23" => "Fichier",
"24" => "Dossier parent",
"25" => "Transférer un ou plusieurs fichiers (max ".Pydio\Conf\Core\ConfService::getConf('UPLOAD_MAX_NUMBER').") dans : ",
...
"plugtype.desc.uploader" => "Implémentation d'outils d'envoi utilisant différentes tachnologies (html, js, jave, ...)",
