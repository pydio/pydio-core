...
class HttpClient
{
    ...
    public $cookie_host = '';
    public $postFileName = "userfile";
    public $postFileData = array();
    ...
    public function postFile($path, $postData, $fileVarName, $fileData)
    {
        $this->path = $path;
        $this->method = 'POST';
    ...
    public function writeContentToStream($destStream)
    {
        $this->contentDestStream = $destStream;
    }

    public function clearContentDestStream()
    {
        $this->contentDestStream = false;
    }

    public function setEventListener($callback)
    {
    ...
    public function setHeadersOnly($boolean, &$collectHeaders = null)
    {
